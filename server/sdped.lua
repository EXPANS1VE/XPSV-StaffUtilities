...
-- Permission Checking....
RegisterServerEvent("XPSV-StaffUtilities.getIsAllowed")
AddEventHandler("XPSV-StaffUtilities.getIsAllowed", function()
    local src = source
    ...
    if identifierDiscord then
		...
		if not (roleIDs == false) then
			for i = 1, #roleIDs do
              ...
              TriggerClientEvent("XPSV-StaffUtilities.returnIsAllowed", src, true)
					end
				end
			end
		else
			--
            TriggerClientEvent("XPSV-StaffUtilities.returnIsAllowed", src, false)
		end
