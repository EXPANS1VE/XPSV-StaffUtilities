...
Citizen.CreateThread(function()
    TriggerServerEvent("XPSV-StaffUtilities.getIsAllowed")
end)


RegisterNetEvent("XPSV-StaffUtilities.returnIsAllowed")
AddEventHandler("XPSV-StaffUtilities.returnIsAllowed", function(isAllowed)
